...
import { Edit, Trash2, Plus, User, Mail, Phone } from "lucide-react";
    ...
    <div className="glass-card rounded-xl overflow-hidden">
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          ...
          <tbody>
            {clients?.map((client) => (
              <tr key={client.id} className="table-row border-b border-white/10">
                <td className="p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">{client.notes || "No notes"}</p>
                    </div>
                  </div>
                </td>
                <td className="p-4">
      ...
      <div className="p-4 border-t border-white/10 flex items-center justify-between">
        <p className="text-sm text-gray-400">
          Showing 1-{clients?.length || 0} of {clients?.length || 0} clients
        </p>
      </div>
    </div>
  );
